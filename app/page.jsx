  ...
  return (
   <div>
    ...
    <section className="w-full">
      <div className = " mx-auto py-24 bg-gradient-to-b from-gray-200 via-gray-100 to-gray-400 rounded-lg">
      ...
      <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">Join thousands of professionals who are advancing their careers with AI-powered guidance.
      </p>
